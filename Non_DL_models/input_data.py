"""
Generate mini-batch training data for LR/SVM
"""
import copy,random
...
class DatasetManager:
    ...
    def __init__(self,
        ...
        self.train_valid_set_input = self.trainset['positive'] + self.trainset['negative'] + copy.deepcopy(self.validset_input)
        self.train_valid_set_output = [0] * len(self.trainset['positive']) + [1] * len(self.trainset['negative']) + copy.deepcopy(self.validset_output)
